#---------------------------------------------#
# source code leak by ! ! 이미지#6625----------#
# 소스코드 배포 ! ! 이미지#6625-----------------#
# 재판매 금지 배포금지 (깃헙 링크를 뿌리세여)-----#
#---------------------------------------------#
import requests, random, time
from os import system
import string
system('title 스포티파이 계정 생성기｜Made By 와핑#4751｜discord.gg/n8AP2nQZYU')
print('해당 상품은 스포티파이 계정 생성기 입니다.')
time.sleep(1)
print('해당 상품의 개발자는 와핑#4751 입니다.')
time.sleep(1)
print('---------------------------------------------------------------------------')
